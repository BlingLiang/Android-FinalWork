...
public class TestListNews1 extends ListActivity implements Runnable, AdapterView.OnItemClickListener {
        ...
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                if (msg.what == 3) {
                    ...
                    SimpleAdapter adapter = new SimpleAdapter(TestListNews1.this, tList, // listItems数据源
    ...
    public void run() {
        ...
        try {
            Thread.sleep(3000);
            Document doc = Jsoup.connect("http://www.mrcj88.cn").get();
            Elements mains = doc.getElementsByClass("m-list-container");
